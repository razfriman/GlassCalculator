...
/**
 * Class that can parse and compute the value of an arithmetic equation
 * Builds a tree that represents the equation in RPN (Reverse Polish Notation)
 * @author Raz Friman
 *
 */
public class EquationParser {
	 ...
	 * @param tokens
	 * @return a LinkedList containing the Output Queue in RPN (Reverse Polish Notation) form
	 */
	public LinkedList<Token> buildParseTree(ArrayList<String> tokens) {
		...
		for (int i = 0; i < tokens.size(); i++) {
			...
			try {
				...
				// Pop and push all operators on the stack with higher precedence than the current operator
		...
		// Pop the remaining operators from the stack and push them on to the queue.
		while (!operatorStack.isEmpty()) {
			outputQueue.add(operatorStack.pop());
		}
	...
	/**
	 * Handle the complete process of computing the value of an equation in string format.
	 * @param input
